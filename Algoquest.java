...
public class Algoquest {
    ...
    /******************************************************************************/
    {
        ...
        return (ereaIsBlock(l, ((r - l) / 2) + l, t, ((t - b) / 2) + b, arrayOfShaps))
                && (ereaIsBlock(((r - l) / 2) + l, r, t, ((t - b) / 2) + b, arrayOfShaps))
                && (ereaIsBlock(l, ((r - l) / 2) + l, ((t - b) / 2) + b, b, arrayOfShaps))
                && (ereaIsBlock(((r - l) / 2) + l, r, ((t - b) / 2) + b, b, arrayOfShaps));
