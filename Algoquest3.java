...
public class Algoquest3
{
    ...
    /***************************************************************************************/
    {
        ...
        for(i=0;i<length;i++)
        {
            ...
            int t3 = (int)Math.ceil(t2);
            int b3 = (int)b2;
            int r3 = (int)Math.ceil(r2);
            int l3 = (int)l2;
            ...
            Rectangle target = new Rectangle(ll ,rr ,rr - ll ,tt - bb );
            Rectangle disrupt = new Rectangle(l3 ,r3 ,r3 - l3 ,t3 - b3 );
            
             if( target.intersects(disrupt ) )
             {
            	    return false;
             }
            //               top left                                 top right
//            if( ( ( (b<t2)&&(t2<=t)&&(l<=l2)&&(l2<r) )|| (b<t2)&&(t2<=t)&&(l<r2)&&(r2<=r) ) ){      //--1
//                return false;
//            }
//             //            bottom left                                bottom right
//            if(  ( (b<=b2)&&(b2<t)&&(l<=l2)&&(l2<r) )|| ( (b<=b2)&&(b2<t)&&(l<r2)&&(r2<=r) ) ){      //--2
//               return false;
//            }
...
//    
   ...
   /******************checking if a given cordinates is in a shape Bound**************/
    ...
    /*************************************************************************************/
     {
         ...
         if ((b1!=null)&&(b2!=null)&&(b3!=null)&&(b4!=null) ){
          f1=b1.combine(b2);  //combin b1 and b2 to new list- f1
          f2=b2.combine(b1); 
          f1.refresh();
          f2.refresh();
          ...
          f1=f1.combine(b3);  //combin f1 and b3 to new list- f1
          f2=b3.combine(f1);
          f1.refresh();
          f2.refresh();
          ...
          f1=f1.combine(b4);  //combin f1 and b4 to new list- f1  
          f2=b4.combine(f1);
          f1.refresh();
          f2.refresh();
        ...
        //   f2=f2.combin(f1);
           ...
           f3=f2.combine(b3);  //combin f1 and b3 to new list- f1
           f4=b3.combine(f3);
        ...
        if ((b1!=null)&&(b2!=null)&&(b3==null)&&(b4!=null) ){
             ...
             f2=f2.combine(b4);  //combin f2 and b4 to new list- f1
             f3=b4.combine(f2);
        ...
        if ((b1!=null)&&(b2==null)&&(b3!=null)&&(b4!=null) ){
             f1=b1.combine(b3);  //combin b1 and b3 to new list- f1
             f2=b3.combine(b1);
             
             f2=f1.unit(f2);
             
             f3=f2.combine(b4);  //combin f2 and b4 to new list- f1
             f4=b4.combine(f3);
        ...
        if ((b1==null)&&(b2!=null)&&(b3!=null)&&(b4!=null) ){
             f1=b2.combine(b3);  //combin b2 and b3 to new list- f1            
             f2=b3.combine(f1);
             ...
             f3=f1.combine(b4);  //combin f1 and b4 to new list- f1
             f4=b4.combine(f3);
            ...
            /// 2 lists are null
        if ((b1==null)&&(b2==null)&&(b3!=null)&&(b4!=null) ){
             f1=b3.combine(b4);  //combin b3 and b4 to new list- f1              
             f2=b4.combine(f1);
          ...
          if ((b1!=null)&&(b2==null)&&(b3==null)&&(b4!=null) ){
            f1=b1.combine(b4);  //combin b1 and b4 to new list- f1 
            f2=b4.combine(f1);
             return f2;
            }   
          if ((b1!=null)&&(b2!=null)&&(b3==null)&&(b4==null) ){
          ...
          if ((b1!=null)&&(b2==null)&&(b3!=null)&&(b4==null) ){
            ...
            if ((b1==null)&&(b2!=null)&&(b3==null)&&(b4!=null) ){
             f1=b2.combine(b4);  //combin b2 and b4 to new list- f1     
             f2=b4.combine(f1);
             f2=f2.unit(f1);
             return f2;
            }
...
//if( ( (b<t2)&&(t2<=t)&&(l<r2)&&(r2<=r) )|| ( (b<t2)&&(t2<=t)&&(l<=l2)&&(l2<r) ) ){      //--1
//  return false;
//}
//if( ( (b<=b2)&&(b2<t)&&(l<r2)&&(r2<=r) )|| ( (b<=b2)&&(b2<t)&&(l<=l2)&&(l2<r) ) ){      //--2
// return false;
//}
//// case 2
//if( ( (t2<=t)&&(t2>b)&&(r2>r)&&(l2<r) )|| ( (t2<=t)&&(t2>b)&&(l2<l)&&(r2>l) ) ){	     //--3
//  return false;
//}                                                    
//if( ( (b2>=b)&&(b2<t)&&(r2>r)&&(l2<r) )|| ( (b2>=b)&&(b2<t)&&(l2<l)&&(r2>l) ) ){       //--4
// return false;
//}
//// case 3
//if( ( (t2>=t)&&(b2<t)&&(r2<=r)&&(r2>l) )|| ( (t2>=t)&&(b2<t)&&(l2>=l)&&(l2<r) ) ){    //--5
//  return false;
//}
////   ( (b2<b)&&(t2>b)&&(l2>=l)&&(l2<r) ) ){
//  
//if( ( (t2<=t)&&(t2>b)&&(r2<=r)&&(r2>l) )|| ( (t2<=t)&&(t2>b)&&(l2>=l)&&(l2<r) ) ){     //--6
// return false;
//}
//if ( (t2>=t)&&(b2<=b)&&(r2>=r)&&(l2<=l) ){   //--7
//  return false;
//}
