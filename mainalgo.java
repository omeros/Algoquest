...
public class mainalgo
{
    ...
    public static void main (String[]  args)
   {
    /**   Bound bo1=new Bound(0,8,8,0);
       ...
       /****************************************************************/
       Bound mainb=new Bound (0,16,16,0); // (l,r,t,b)
       
       Bound b2=new Bound (2,4,12,8);       //  top  left 
      ...
      // BoundNode Node2=new BoundNode(b2,null);
       ...
       Algoquest a= new Algoquest();
       boolean ans1=a.ereaIsBlock(0,8,8,0,array);
       boolean ans2=a.ereaIsClear(0,8,16,8,array);
       ...
       list2=a.findMax(0,16,16,0,array);       /** <==============================*/
